 ...
 *     },
 *     url?: array{
 *         command_api: scalar|null|Param,
 *         api: scalar|null|Param,
 *     },
 * }
 ...
 *         loa: scalar|null|Param, // The LOA level of the Gssp
 *     }>,
 ...
 *         query_string_field_name: scalar|null|Param, // The name of the query string field that triggers the preferred activation flow
 *         options?: list<scalar|null|Param>,
 *         saml_attribute_field_name: scalar|null|Param, // The name of the entitlement attribute (in SAML assertion) that is read to determine the preferred activation flow
 *         saml_attributes: array{
 *             ra: scalar|null|Param, // The entitlement attribute name for the ra vetting flow
 *             self: scalar|null|Param, // The entitlement attribute name for the self vetting flow
 *         },
 *     },
 * }
 ...
 *         },
 *         view_config?: array{
 *             loa: scalar|null|Param, // The loa level (for now 1-3 are supported)
 *             logo: scalar|null|Param, // The absolute path to the logo of the gssp
 *             app_android_url?: scalar|null|Param, // The optional Android app Play store URL // Default: false
 *             app_ios_url?: scalar|null|Param, // The optional iOs app Itunes store URL // Default: false
 *             alt?: array{
 *                 en_GB: scalar|null|Param, // English alt text translation
 *                 nl_NL: scalar|null|Param, // Dutch alt text translation
 *             },
 *             title?: array{
 ...
 *             },
 *             description?: array{
 *                 en_GB: scalar|null|Param, // English description of the gssp
 *                 nl_NL: scalar|null|Param, // Dutch description of the gssp
 *             },
 *             button_use?: array{
 *                 en_GB: scalar|null|Param, // English text shown on the use button
 *                 nl_NL: scalar|null|Param, // Dutch text shown on the use button
 *             },
 *             initiate_title?: array{
 *                 en_GB: scalar|null|Param, // English initiate title text
 *                 nl_NL: scalar|null|Param, // Dutch initiate title text
 *             },
 *             initiate_button?: array{
 *                 en_GB: scalar|null|Param, // English initiate button text
 *                 nl_NL: scalar|null|Param, // Dutch initiate button text
 *             },
 *             explanation?: array{
 *                 en_GB: scalar|null|Param, // English explanation for step 2
 *                 nl_NL: scalar|null|Param, // Dutch explanation for step 2
 *             },
 *             authn_failed?: array{
 *                 en_GB: scalar|null|Param, // English text shown when authn request failed
 *                 nl_NL: scalar|null|Param, // Dutch text shown when authn request failed
 *             },
 *             pop_failed?: array{
 *                 en_GB: scalar|null|Param, // English text shown on failed proof of posession
 *                 nl_NL: scalar|null|Param, // Dutch text shown on failed proof of posession
 *             },
 *         },
 *     }>,
 * }
